...
<c:if test="${list != null }">
 <table class="type09" align="center" width = "900">
	...
	<c:forEach var="list"  items="${ list }">    		
	   	<tbody>
		<tr>
			<td align="center" width="50" id="hrid">${ list.free_num }</td>
			<td align="center" width="400"> <a 	href="content.do?num=${list.free_num }&pageNum=1">
	...
	<div style="float: right; margin-right:200px">
            <form action="list.do" name="golist" >
